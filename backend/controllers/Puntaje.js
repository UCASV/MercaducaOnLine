...
export const ActualizarPromedio = async (req, res) => {
  ...
  try {
    ...
    const prodQuery = await pool
      .request()
      .input("id_empxprod", sql.Int, id_empxprod).query(`
    ...
    await pool
      ...
      .input("votos", sql.Int, votosProd).query(`
    ...
    const promedioEmp = await pool.request().input("id_emp", sql.Int, id_emp)
      .query(`
    ...
    await pool
      ...
      .input("prom", sql.Float, promEmp).query(`
